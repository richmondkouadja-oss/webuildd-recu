...
export default function ReceiptForm() {
  ...
  async function onSubmit(data: ReceiptFormValues) {
    ...
    try {
      ...
      const receiptData = {
        ...
        superficie: Number(String(data.superficie).replace(/[^\d]/g, '')) || null,
  ...
  const STEPS = ['En-tête', 'Client', 'Bien', 'Finance', 'Signatures'];
    ...
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        ...
        {step === 3 && (
          <Card>
            <CardHeader>
              <CardTitle className="text-lg">Bien acheté</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              {/* Toggle Terrain / Maison */}
              <div className="flex gap-2">
                <Controller
                  control={control}
                  name="property_type"
                  ...
                  <div>
                    ...
                    {watch('lotissement_name') === '__other' && (
                      <Input
                        ...
                        onChange={(e) => setValue('lotissement_name', e.target.value)}
                      />
                    )}
                  </div>
                  <div>
